...
class Modelo:
    ...
    Attributes:
        ...
        - tiempo_max_atencion (int): Tiempo máximo historico de atención en segundos.
    ...
    def procesar_atencion(self, tiempo: int) -> None:
        ...
        for box in self.boxes:
            ...
            if not box.ocupado and self.cola:
                ...
                tiempo_atencion:int = np.ceil(np.random.normal(self.tiempo_atencion_media, self.tiempo_atencion_sd))
